...
- Run B: **162 sites** (`xwiki/xwiki-platform#6293` 83, `xwiki/xwiki-commons#1945` 60,
  `xwiki/xwiki-rendering#427` 19) over 33 modules, 4120 tests green, `revapi:check` passing in every
  one of them.
